...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t koptimizedLinear_string = 0x5315;
  static constexpr Tagged_t kother_string = 0x5331;
  static constexpr Tagged_t koverflow_string = 0x5345;
  static constexpr Tagged_t kownKeys_string = 0x5359;
  static constexpr Tagged_t kpercent_string = 0x536d;
  static constexpr Tagged_t kplainDate_string = 0x5381;
  static constexpr Tagged_t kplainTime_string = 0x5399;
  static constexpr Tagged_t kposition_string = 0x53b1;
  static constexpr Tagged_t kpreventExtensions_string = 0x53c5;
  static constexpr Tagged_t kprivate_constructor_string = 0x53e5;
  static constexpr Tagged_t kPromise_string = 0x53fd;
  static constexpr Tagged_t kpromise_string = 0x5411;
  static constexpr Tagged_t kproto_string = 0x5425;
  static constexpr Tagged_t kproxy_string = 0x543d;
  static constexpr Tagged_t kProxy_string = 0x5451;
  static constexpr Tagged_t kquery_colon_string = 0x5465;
  static constexpr Tagged_t kRangeError_string = 0x5475;
  static constexpr Tagged_t kraw_json_string = 0x548d;
  static constexpr Tagged_t kraw_string = 0x54a1;
  static constexpr Tagged_t kReferenceError_string = 0x54b1;
  static constexpr Tagged_t kReflectGet_string = 0x54cd;
  static constexpr Tagged_t kReflectHas_string = 0x54e5;
  static constexpr Tagged_t kRegExp_string = 0x54fd;
  static constexpr Tagged_t kregexp_to_string = 0x5511;
  static constexpr Tagged_t kreject_string = 0x552d;
  static constexpr Tagged_t krelativeTo_string = 0x5541;
  static constexpr Tagged_t kresizable_string = 0x5559;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5571;
  static constexpr Tagged_t kreturn_string = 0x5591;
  static constexpr Tagged_t krevoke_string = 0x55a5;
  static constexpr Tagged_t kroundingIncrement_string = 0x55b9;
  static constexpr Tagged_t kRuntimeError_string = 0x55d9;
  static constexpr Tagged_t kWebAssemblyException_string = 0x55f1;
  static constexpr Tagged_t kScript_string = 0x5615;
  static constexpr Tagged_t kscript_string = 0x5629;
  static constexpr Tagged_t ksecond_string = 0x563d;
  static constexpr Tagged_t kseconds_string = 0x5651;
  static constexpr Tagged_t kshort_string = 0x5665;
  static constexpr Tagged_t kSet_string = 0x5679;
  static constexpr Tagged_t ksentence_string = 0x5689;
  static constexpr Tagged_t kset_space_string = 0x569d;
  static constexpr Tagged_t kset_string = 0x56ad;
  static constexpr Tagged_t kSetIterator_string = 0x56bd;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x56d5;
  static constexpr Tagged_t kShadowRealm_string = 0x56f1;
  static constexpr Tagged_t kSharedArray_string = 0x5709;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5721;
  static constexpr Tagged_t kSharedStruct_string = 0x5741;
  static constexpr Tagged_t ksign_string = 0x5759;
  static constexpr Tagged_t ksize_string = 0x5769;
  static constexpr Tagged_t ksmallestUnit_string = 0x5779;
  static constexpr Tagged_t ksource_string = 0x5791;
  static constexpr Tagged_t ksourceText_string = 0x57a5;
  static constexpr Tagged_t kstack_string = 0x57bd;
  static constexpr Tagged_t kstackTraceLimit_string = 0x57d1;
  static constexpr Tagged_t kstatic_initializer_string = 0x57ed;
  static constexpr Tagged_t ksticky_string = 0x580d;
  static constexpr Tagged_t kString_string = 0x5821;
  static constexpr Tagged_t kstring_string = 0x5835;
  static constexpr Tagged_t kstring_to_string = 0x5849;
  static constexpr Tagged_t ksuppressed_string = 0x5865;
  static constexpr Tagged_t kSuppressedError_string = 0x587d;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5899;
  static constexpr Tagged_t kSymbol_match_all_string = 0x58b5;
  static constexpr Tagged_t kSymbol_replace_string = 0x58d1;
  static constexpr Tagged_t ksymbol_species_string = 0x58ed;
  static constexpr Tagged_t kSymbol_species_string = 0x5909;
  static constexpr Tagged_t kSymbol_split_string = 0x5925;
  static constexpr Tagged_t kSymbol_string = 0x593d;
  static constexpr Tagged_t ksymbol_string = 0x5951;
  static constexpr Tagged_t kSyntaxError_string = 0x5965;
  static constexpr Tagged_t ktarget_string = 0x597d;
  static constexpr Tagged_t kthis_function_string = 0x5991;
  static constexpr Tagged_t kthis_string = 0x59ad;
  static constexpr Tagged_t kthrow_string = 0x59bd;
  static constexpr Tagged_t ktimed_out_string = 0x59d1;
  static constexpr Tagged_t ktimeZone_string = 0x59e9;
  static constexpr Tagged_t ktoJSON_string = 0x59fd;
  static constexpr Tagged_t ktoString_string = 0x5a11;
  static constexpr Tagged_t ktrue_string = 0x5a25;
  static constexpr Tagged_t ktotal_string = 0x5a35;
  static constexpr Tagged_t kTypeError_string = 0x5a49;
  static constexpr Tagged_t kUint16Array_string = 0x5a61;
  static constexpr Tagged_t kUint32Array_string = 0x5a79;
  static constexpr Tagged_t kUint8Array_string = 0x5a91;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5aa9;
  static constexpr Tagged_t kundefined_string = 0x5ac9;
  static constexpr Tagged_t kundefined_to_string = 0x5ae1;
  static constexpr Tagged_t kunicode_string = 0x5b01;
  static constexpr Tagged_t kunicodeSets_string = 0x5b15;
  static constexpr Tagged_t kunit_string = 0x5b2d;
  static constexpr Tagged_t kURIError_string = 0x5b3d;
  static constexpr Tagged_t kUTC_string = 0x5b51;
  static constexpr Tagged_t kWeakMap_string = 0x5b61;
  static constexpr Tagged_t kWeakRef_string = 0x5b75;
  static constexpr Tagged_t kWeakSet_string = 0x5b89;
  static constexpr Tagged_t kweek_string = 0x5b9d;
  static constexpr Tagged_t kweeks_string = 0x5bad;
  static constexpr Tagged_t kweekOfYear_string = 0x5bc1;
  static constexpr Tagged_t kwith_string = 0x5bd9;
  static constexpr Tagged_t kword_string = 0x5be9;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5bf9;
  static constexpr Tagged_t kyear_string = 0x5c19;
  static constexpr Tagged_t kyears_string = 0x5c29;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5c3d;
  static constexpr Tagged_t kHashTableHoleValue = 0x5c49;
  static constexpr Tagged_t kPromiseHoleValue = 0x5c55;
  static constexpr Tagged_t kUninitializedValue = 0x5c61;
  static constexpr Tagged_t kArgumentsMarker = 0x5c6d;
  static constexpr Tagged_t kTerminationException = 0x5c79;
  static constexpr Tagged_t kException = 0x5c85;
  static constexpr Tagged_t kOptimizedOut = 0x5c91;
  static constexpr Tagged_t kStaleRegister = 0x5c9d;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5ca9;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5cb5;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5cc1;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5cd1;
  static constexpr Tagged_t kconsole_context_id_symbol = 0x5ce1;
  static constexpr Tagged_t kconsole_context_name_symbol = 0x5cf1;
  static constexpr Tagged_t kclass_fields_symbol = 0x5d01;
  static constexpr Tagged_t kclass_positions_symbol = 0x5d11;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5d21;
  static constexpr Tagged_t kerror_message_symbol = 0x5d31;
  static constexpr Tagged_t kerror_script_symbol = 0x5d41;
  static constexpr Tagged_t kerror_stack_symbol = 0x5d51;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5d61;
  static constexpr Tagged_t kfrozen_symbol = 0x5d71;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5d81;
  static constexpr Tagged_t knative_context_index_symbol = 0x5d91;
  static constexpr Tagged_t knonextensible_symbol = 0x5da1;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5db1;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5dc1;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5dd1;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5de1;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5df1;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5e01;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5e11;
  static constexpr Tagged_t ksealed_symbol = 0x5e21;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5e31;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5e41;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5e51;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5e61;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5e71;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5e81;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5e91;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x5ea1;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x5eb1;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x5ec1;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5ed1;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5ee1;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5f11;
  static constexpr Tagged_t kmatch_symbol = 0x5f49;
  static constexpr Tagged_t ksearch_symbol = 0x5f71;
  static constexpr Tagged_t kunscopables_symbol = 0x5f9d;
  static constexpr Tagged_t kdispose_symbol = 0x5fcd;
  static constexpr Tagged_t kasync_dispose_symbol = 0x5ff9;
